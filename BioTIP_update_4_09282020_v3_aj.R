...
{
  # sparse matrix conversion
  if(class(simulation) == "dgCMatrix"){
    simulation = as.matrix(simulation)
  }
...
#'
#' @description This function takes in one (or two) matrices X 
#' (rows are genes, columns are samples) (and Y).
